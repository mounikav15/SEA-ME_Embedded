...
int main (int argc, char **argv)
{
    ...
    while (1) 
    {
        ...
        if (!dbus_message_iter_append_basic(&iter_speed, DBUS_TYPE_DOUBLE, &speed_value)) 
        {
        ...
        if (!dbus_message_iter_append_basic(&iter_rpm, DBUS_TYPE_DOUBLE, &rpm_value)) 
        {
